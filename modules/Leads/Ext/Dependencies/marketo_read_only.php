...
$dependencies['Leads']['readonly_mrkto2_inferred_country_c'] = array(
    'hooks' => array("edit"),
...
$dependencies['Leads']['readonly_mrkto2_anonymousip_c'] = array(
    'hooks' => array("edit"),
    'trigger' => 'true', //Optional, the trigger for the dependency. Defaults to 'true'.
...
$dependencies['Leads']['readonly_mrkto2_inferred_company_c'] = array(
    'hooks' => array("edit"),
    'trigger' => 'true', //Optional, the trigger for the dependency. Defaults to 'true'.
...
$dependencies['Leads']['readonly_mrkto2_unsubscribed_c'] = array(
    'hooks' => array("edit"),
    'trigger' => 'true', //Optional, the trigger for the dependency. Defaults to 'true'.
...
$dependencies['Leads']['readonly_mrkto2_unsubscribed_date_c'] = array(
    'hooks' => array("edit"),
    'trigger' => 'true', //Optional, the trigger for the dependency. Defaults to 'true'.
...
$dependencies['Leads']['readonly_mrkto2_invalid_email_date_c'] = array(
    'hooks' => array("edit"),
    'trigger' => 'true', //Optional, the trigger for the dependency. Defaults to 'true'.
...
$dependencies['Leads']['readonly_mkto_id'] = array(
    'hooks' => array("edit"),
    'trigger' => 'true', //Optional, the trigger for the dependency. Defaults to 'true'.
